    ...
    <section class="bookdetail">
        ...
        <div class="book-detailinfo">
            ...
            <div class="detailTabCon">
                <template v-if="tabselect === 'introduce'">
                    <div class="detailTabCon">
                        <h2 class="tabcontit"><strong>"{{ bookName }}"</strong>를 소개합니다.</h2>
                        <p>
                ...
                <template v-else-if="tabselect=='review'">
                    <div class="detailTabCon">
                        <h2 class="tabcontit"><strong>"{{ bookName }}"</strong>출판사 리뷰 입니다.</h2>
                        <p>
                ...
                <template v-else-if="tabselect=='order'">
                    <div class="detailTabCon">
                        <h2 class="tabcontit"><strong>"{{ bookName }}"</strong>목차 입니다</h2>
                        <p>
                ...
                <template v-else-if="tabselect=='write'">
                    <div class="detailTabCon">
                        <h2 class="tabcontit"><strong>"{{ bookName }}"</strong>저자소개 입니다.</h2>
                        <p>
                ...
                <template v-else-if="tabselect=='recommendation'">
                    <div class="detailTabCon">
                        <h2 class="tabcontit"><strong>"{{ bookName }}"</strong>추천의 글 입니다.</h2>
                        <p>
                ...
                <template v-else-if="tabselect=='reference'">
                    <div class="detailTabCon">
                        <h2 class="tabcontit"><strong>"{{ bookName }}"</strong>자료실 입니다.</h2>
