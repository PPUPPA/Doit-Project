    ...
    <section class="maincontents">
        ...
        <section class="newbook">
            ...
            <div class="tabcontent">
                <div class="tab">
                    <b-button variant="tab" class="active" @click="AddContents('Newbooks_it')">IT 전문서</b-button>
                    <b-button variant="tab" @click="AddContents('Newbooks_work')">업무 능력, 기타</b-button>
                    <b-button variant="tab" @click="AddContents('Newbooks_photo')">사진 예술</b-button>
                    <b-button variant="tab" @click="AddContents('Newbooks_science')">데이터 과학</b-button>
                </div>
                <VueSlickCarousel class="mainslider" v-bind="settings">
                    <div class="rollimg" v-for="(item, index) in Newbooks" :key="index">
                        <span class="imgbox"><img :src="item.imgurl" :alt="item.name"></span>
        ...
        <section class="searchbook">
            ...
            <div class="inputarea">
                ...
                <div class="autolayer" v-if="keyword.length > 0" :class="{none: autocomplete.length === 0}">
                    <ul v-if="autocomplete.length > 0">
                        <li v-for="(item, index) in autocomplete[0].books" :key="index">{{ item.booktit }}</li>
                    </ul>
            ...
            <div class="guidehash">
                <span v-for="(item, index) in hashdata" :key="index">{{ item.text }}</span>
            </div>
        </section>
        ...
        <section class="notice">
            <div class="noticebox">
                ...
                <b-button type="button" variant="noticemore" @click="viewmore($event)"><span class="blind">더 보기</span></b-button>
...
export default {
    ...
    methods: {
        ...
        viewmore(e) {
            if(e.target.parentElement.classList.value.indexOf("full") > -1) {
